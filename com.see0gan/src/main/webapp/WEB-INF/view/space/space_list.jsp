...
<body>
	<div class="my-page-container">
		<div class="my-page-wrapper">
			<div class="my-page-header">공간 목록</div>
			<div class="booking-list">
				...
				%>
				<div class="list-book"><a href="space_detail.sgg?tbsp_num=<%=sp_BasicInfoVO.getTbsp_num()%>">
					
					<div class="list-space-title"><%=sp_BasicInfoVO.getTbsp_name() %></div>
					<div class="list-date-wrapper">
						<div class="list-book-date"><%=sp_BasicInfoVO.getTbsp_intro1() %></div>
					</div>
					
					<div class="list-information-wrapper">
						<div class="list-date-s-wrapper">
							<div class="list-date-s"><%=sp_BasicInfoVO.getTbsp_img1() %></div>
						</div>

						<div class="list-date-e-wrapper">
							<div class="list-date-e"><%=sp_BasicInfoVO.getTbsp_img2()%></div>
						</div>

						<div class="type-wrapper">
							<div><%=sp_BasicInfoVO.getTbsp_type() %></div>
						</div>
					</div>
				</a></div>
				<%
