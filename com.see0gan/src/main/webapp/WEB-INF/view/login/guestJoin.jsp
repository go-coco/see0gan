...
<div class="content_wrap">
	...
	<form name ="form-signup" id="form-signup" class="log_join_form">
		<input type ="text" id="i-nickname" name="TBU_NICKNAME" placeholder="닉네임">
		<div class="form_check" id="nickname_check"></div>
		<input type ="text" id="i-name" name="TBU_NAME" placeholder="이름">
		<div class="form_check" id="name_check"></div>
		<input type ="text" id="i-email" name="TBU_EMAIL" placeholder="이메일">
		<div class="form_check" id="email_check"></div>
		<input type ="text" id= "i-password" name="TBU_PASSWORD" placeholder="비밀번호">
		...
		<input type ="text" id= "i-phone" name="TBU_PHONE" placeholder="휴대폰 번호">
		<div class="form_check" id="phone_check"></div>
	 	<input type="button" id="btn-submit" class="btn-submit" value="가입하기"/>
	</form>
	</div>
</div>
</div>
