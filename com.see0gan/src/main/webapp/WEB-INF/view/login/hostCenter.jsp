...
<link rel="stylesheet" href="<%=request.getContextPath() %>/resources/css/hostcenter.css">
...
<div class="content_wrap">
	<section class="host_section" id="host_section1">
		...
		<div>
			<a href="/space/basicInfo_Form.sgg" class="hostc_btn">공간 등록하기</a>
			<a href="/host/hostLogin.sgg" class="hostc_btn">호스트 로그인</a>
		</div>
		<div class="host_sub_txt">
			<span class="text-title">| 등록 가능 공간 |</span>
			<span class="text-content"> 모임 · 촬영  · 연습 · 행사 · 회의까지</span>
		</div>
	<img src="../resources/img/hostcenter_main.jpg" width="400px">
	</section>
